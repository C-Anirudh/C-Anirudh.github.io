...
We can see that the developer must have commited the `backup.sh` file before (1st commit) which he has now put in the `.gitnore` file now.
...
The flag was displayed on screen after loggin in.
