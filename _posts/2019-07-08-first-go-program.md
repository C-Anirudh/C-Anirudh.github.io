...
The `import` statement is used to import the standard libraries which we download when we install Go. The standard libraries were provided by the developers of Go to make our lives easier and contain commonly used functions. If you have used other programming langauages like C or Java, this will not be alien to you.
