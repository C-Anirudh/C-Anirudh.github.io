...
![Challenge Quesion](/assets/img/posts/tjctf-gamerw-writeup/chall-question.png "Gamer W")
...
I froze the value in the address storing the health and gave myself a whole lot of gold coins by changing the value in the address holding the amount of gold coins. Now that I was wealthy and invinvible 😈, I maxed out my character from the store and went to face the boss again.

![Challenge Image](/assets/img/posts/tjctf-gamerw-writeup/chall-max.png "Maxed out Shop")

However, as I was getting close to killing him, the boss drank something (a potion), which gave him regenrative health. If I was somehow able to give him a hit before the potion took its effect, he teleported and put me behind a barricade, making it impossible for me to reach him.
...
I looked at the items in the store again and realised that if I could change the `swing damage` from my weapon to a very high value, I could kill the boss quickly even with his regerative powers! Using Cetus' search feature again, I got hold of the address storing my weapon's swing damage value and increased it.

![Challenge Image](/assets/img/posts/tjctf-gamerw-writeup/chall-cetus-addresses.png "Cetus addreses")
...
![Challenge Image](/assets/img/posts/tjctf-gamerw-writeup/chall-flag.png "Chall Flag")