...
tags: [oracle, experience]
pin: true
image:
  src: /assets/img/posts/placement-preparation/oracle.jpg
  alt: Oracle
---
...
![Print string in zig-zag format](/assets/img/posts/placement-preparation/oracle-coding-example1.png "Print string in zig-zag format")
![Print string in zig-zag format](/assets/img/posts/placement-preparation/oracle-coding-example2a.png "Print string in zig-zag format")
![Print string in zig-zag format](/assets/img/posts/placement-preparation/oracle-coding-example2b.png "Print string in zig-zag format")
...
- DBMS questions
    ...
    - What is transaction? I was also asked about the life cycle of a transaction (partially commited, commited, ROLLBACK). 
...
You can also find my experience penned down in GFG ([https://www.geeksforgeeks.org/oracle-gbu-interview-experience-campus-placement-drive-2020-virtual-process/](https://www.geeksforgeeks.org/oracle-gbu-interview-experience-campus-placement-drive-2020-virtual-process/)).